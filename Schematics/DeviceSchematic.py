#super class which defines a Schematic device
# kind of the frontend of the schematic mode
...
class DeviceSchematic():
    ...
    #calculates the angle needed to rotate given schematic image
    ...
    def notCompletelyConnected(self):
        return self.getNode1().numConnected() == 0 or self.getNode2().numConnected() == 0
